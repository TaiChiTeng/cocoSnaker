...
pyglet.resource.path.append('../res/data')
pyglet.resource.reindex()
here = os.path.split(os.path.abspath(__file__))[0]
pyglet.font.add_directory(os.path.join(here,"../res/data"))       #why error?!
...
class ScoresLayer( ColorLayer):
    ...
    def __init__(self):
        ...
        title = Label('SNAKER', **self.font_title )
...
class OptionsMenu( Menu ):
    def __init__(self):
        super( OptionsMenu, self).__init__('SNAKER') 
...
if __name__ == "__main__":
    ...
    #print "after adding path:",pyglet.resource.path
    """
    print "os.path.join(here,&&&):",os.path.join(here,"../res/data")
    print "os.path.abspath(__file__)[0]:",here
    print "os.path.abspath(__file__):",os.path.abspath(__file__)
    print "__file__:",__file__
    """
    
    director.init( resizable=True, width=600, height=600 )
    scene = Scene()
